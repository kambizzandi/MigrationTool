...
#ifndef TARGOMAN_MIGRATE_CMDSHOWCONF_H
#define TARGOMAN_MIGRATE_CMDSHOWCONF_H
...
class cmdShowConf : public intfCommand
{
public:
    instanceGetterPtr(cmdShowConf);
    cmdShowConf();
...
#endif // TARGOMAN_MIGRATE_CMDSHOWCONF_H

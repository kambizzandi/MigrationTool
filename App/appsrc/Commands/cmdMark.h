...
#ifndef TARGOMAN_MIGRATE_CMDMARK_H
#define TARGOMAN_MIGRATE_CMDMARK_H
...
class cmdMark : public intfCommand
{
public:
    instanceGetterPtr(cmdMark);
    cmdMark();
...
#endif // TARGOMAN_MIGRATE_CMDMARK_H
